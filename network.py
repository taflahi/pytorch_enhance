...
class Perceptual(nn.Module):
    ...
    def __init__(self):
        ...
        offset_ = np.array([103.939, 116.779, 123.680],
...
class Discriminator(nn.Module):
    ...
    def __init__(self, channels):
        ...
        self.conv_layer6 = BasicLayer(
            3 * self.channels, 2 * self.channels, 1, 1, 0)
...
class Enhancer(nn.Module):
    ...
    def forward(self, inputs, seeds):
        ...
        c12, c22, c32, perc_out = self.perceptual(
            torch.cat([inputs, gen_out], dim=0))
